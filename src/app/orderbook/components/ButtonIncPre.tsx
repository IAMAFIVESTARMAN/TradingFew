...
const ButtonIncPre = ({ precisonIncHandler, precision }: Click) => {
  const onClickHandler = (precision: string) => {
    switch (precision) {
      case "P5":
        precisonIncHandler?.("P4");
        break;
      case "P4":
        precisonIncHandler?.("P3");
        break;
      case "P3":
        precisonIncHandler?.("P2");
        break;
      case "P2":
        precisonIncHandler?.("P1");
        break;
      case "P1":
        precisonIncHandler?.("P0");
        break;
      case "P0":
        precisonIncHandler?.("incdisbaled");
        break;
      default:
        console.log("break");
    }
